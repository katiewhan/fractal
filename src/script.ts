...
//     addImage = (x, y, rotation) => {
//         const image = new THREE.MeshBasicMaterial({
//             map: new THREE.TextureLoader().load('static/test1.png'), 
//             transparent: true
//         })
//         const plane = new THREE.Mesh(new THREE.PlaneGeometry(50, 50), image)
//         this.scene.add(plane)

//         plane.position.set(x, y, -100)
